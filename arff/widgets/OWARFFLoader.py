...
class OWARFFLoader(OWBaseWidget):
    name = "ARFF Loader"       # Nombre del widget
    description = "Load a dataset from an ARFF file" # Descripcion del widget
    icon = "icons/weka.png" # Icono del widget
...
if __name__ == "__main__":
    # WidgetPreview(OWARFFLoader).run() # Para depurar solo el widget de forma aislada
    Orange.canvas.__main__.main() # Para depurar el widget desde un workflow completo
